...
public class OctreeNode
{
	...
	/** 
	 * Constructor for a basic OctreeNode (default settings). 
	 */
	public OctreeNode() {}
	
	/** 
	 * Root Constructor used to make first Octree node, the parent node. It is further
	 * subdivided using the setKids() function.
	 */
	...
	/** Return the nodes subNode, i is index of subNode. */
	...
	/**
	 * Takes an octree node and divides its subnodes in such a way that the 
	...
	/**
	 * In-Order full traverse, traverses from the deepest subnode, to the root
	 ...
	 * @param Dt Time steps in seconds.
	 ...
	 * @param t Octree Node
	 * @param decayRate Decay rate in seconds^-1.
	 * @param Dt Timestep size to use in seconds.
	 */
