...
public class BSimDdeSolver {
	 ...
	 */
	public static double[] euler(BSimDdeSystem odes, double t, double[] y, double h){
	 ...
	 * @return Vector of dependent variables at next time step.
	 */
	public static double[] rungeKutta23(BSimDdeSystem odes, double t, double[] y, double h){
		int numEq = odes.getNumEq();
	 ...
	 * @return Vector of dependent variables at next time step.
	 */
	public static double[] rungeKutta45(BSimDdeSystem odes, double t, double[] y, double h){
		int numEq = odes.getNumEq();
		double[] dydx = new double[numEq];
		double[] yNew = new double[numEq];
		double[] k1 = new double[numEq];
