...
public class BSimCoordBacterium extends BSimSensingBacterium implements BSimLogic, BSimDrawable {
	 ...
	 */
	public BSimCoordBacterium(double newSpeed, double newMass,
	 ...
	 */
	public BSimCoordBacterium replicate(BSimScene scene, BSimParameters params){
		...
		BSimCoordBacterium newBact = null;
		if(elongationType==BSimBacterium.TRILINEAR_ELONGATION){
			//inherit the trilinear elongation
			newBact = new BSimCoordBacterium(this.speed, this.mass, this.size, this.width, this.timeC, this.time2, this.timeG, this.a1minute, this.a2minute, this.a3minute, this.elongationType, this.direction, newPosition, this.forceMagnitudeDown, this.forceMagnitudeUp, this.state, this.speed, this.remDt, scene, params, this.switchSpeed, this.coordThreshold);
		}
		else{
			//inherit the bilinear elongation
			newBact = new BSimCoordBacterium(this.speed, this.speed, this.size, this.ltc, this.ltg, this.width, this.timeC, this.timeG, this.elongationType, this.direction, newPosition, this.forceMagnitudeDown, this.forceMagnitudeUp, this.state, this.speed, this.remDt, scene, params, this.switchSpeed, this.coordThreshold);
		}
